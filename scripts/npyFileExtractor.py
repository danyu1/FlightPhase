# inspect_tffrs_npy.py
# Quick inspector for a structured .npy file produced by ScrapeFromTfrrs_Fast.py
...
def main():
    ...
    ap.add_argument("-i", "--input", default="tfrrs_performances.npy",
